...
To migrate local GrapeSalad 2E source data, run:
...
The generated `content/` directory is gitignored, and the sibling source
repositories remain read-only. This migration covers characters and physical
room definitions only; printed special-room behavior, cards, haunts, tokens,
and artwork are not yet implemented.
